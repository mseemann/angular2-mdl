...
describe("Service: MdlSnackbar", () => {
  ...
  beforeEach(
    waitForAsync(
      inject(
        [MdlSnackbarService, MdlDialogOutletService],
        (
          service: MdlSnackbarService,
  ...
  it(
    "should show a snackbar and close the snackbar if the aciton button is clicked",
    waitForAsync(() => {
  ...
  it(
    "should show a snackbar and close the snackbar if the action button is clicked or after timeout",
    waitForAsync(() => {
      const fixture = TestBed.createComponent(MdlTestViewComponent);
      fixture.detectChanges();
      const p = mdlSnackbarServcie.showSnackbar({
  ...
  it(
    "should show one snackbar at a time",
    waitForAsync(() => {
      const fixture = TestBed.createComponent(MdlTestViewComponent);
      fixture.detectChanges();
      const p = mdlSnackbarServcie.showSnackbar({
