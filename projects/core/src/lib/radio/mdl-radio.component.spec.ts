...
describe('Component: MdlRadio', () => {
  ...
  it('should support ngModel', async(() => {
    ...
    const component = fixture.debugElement.queryAll(By.directive(MdlRadioComponent))[0];
  ...
  it('should mark the component as focused and blured', () => {
    ...
    const inputEl: HTMLInputElement = fixture.debugElement.queryAll(By.css('input'))[0].nativeElement;

    inputEl.dispatchEvent(new Event('focus'));

    fixture.detectChanges();

    const radioEl: HTMLElement = fixture.debugElement.queryAll(By.directive(MdlRadioComponent))[0].nativeElement;
  ...
  it('should take the name from formcontrolname if no name os provided', async(() => {
    ...
    const radioComponent = fixture.debugElement.query(By.directive(MdlRadioComponent)).componentInstance;
  ...
  it('should be possible to disable the radio input', async(() => {
    ...
    const instance = fixture.componentInstance;
    const cbDebugElem = fixture.debugElement.queryAll(By.directive(MdlRadioComponent))[0];
  ...
  it('should not change its current state if it is already checked', async(() => {
    ...
    const cbDebugElem1 = fixture.debugElement.queryAll(By.directive(MdlRadioComponent))[0];
  ...
  it('should be possible to use the same radio buttons in different groups', () => {
    const fixture = TestBed.createComponent(MdlTestUseSameRadioInGroupsComponent);
    fixture.detectChanges();
