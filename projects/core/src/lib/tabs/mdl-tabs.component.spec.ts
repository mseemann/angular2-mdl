...
describe("Component: MdlTabs", () => {
  ...
  it("should activate the first tab if no index is set", () => {
    ...
    const mdlTabsComponent: MdlTabsComponent = fixture.debugElement.query(
      By.directive(MdlTabsComponent)
    ).componentInstance;
  ...
  it("should recognize enabled/disabled tabs", () => {
    ...
    const fixture = TestBed.createComponent(MdlTestComponent);
    fixture.detectChanges();
    const testElement = fixture.nativeElement.querySelector(
  ...
  it("should not bepossible to to select a disabled tab", () => {
    ...
    const titleDebugElements = fixture.debugElement.queryAll(
      By.css("div.disabled")
    );
  ...
  it("should be possible to create a ripple tab", () => {
    TestBed.overrideComponent(MdlTestComponent, {
      set: {
        template:
          '<mdl-tabs mdl-ripple="true"><mdl-tab-panel></mdl-tab-panel></mdl-tabs>',
      },
    });
    const fixture = TestBed.createComponent(MdlTestComponent);
    fixture.detectChanges();

    const rippleDirective = fixture.debugElement.query(
      By.directive(MdlAnchorRippleDirective)
    );
  ...
  it("should be possible to change the tab count", () => {
    ...
    let debugElements = fixture.debugElement.queryAll(
      By.directive(MdlTabPanelComponent)
    );
