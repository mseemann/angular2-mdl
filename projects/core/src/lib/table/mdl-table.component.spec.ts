...
describe("Component: MdlTableComponent", () => {
  ...
  it('should create a table with class "mdl-data-table', () => {
    ...
    const tableEl: HTMLInputElement = fixture.debugElement.query(
      By.css("table")
    ).nativeElement;
  ...
  it("should select all items if the toggleAll checkbox is clicked", () => {
    ...
    const firstCheckboxEl: HTMLInputElement = fixture.debugElement.query(
    ...
    expect(fixture.componentInstance.selected.length).toBe(
      fixture.componentInstance.tableData.length
    );
  });
  ...
  it("should change the selection to the last table row if the last checkbox is clickt", () => {
    ...
    const firstCheckboxEl: HTMLInputElement =
      checkboxes[checkboxes.length - 1].nativeElement;
    firstCheckboxEl.click();
