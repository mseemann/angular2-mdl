...
export class SelectComponent extends AbstractDemoComponent {
  ...
  autocompleteCountryCode: string | null = null;
  otherCountryCode: string | null = null;
  otherCountryCode2: string | null = null;
  ...
  constructor(router: Router, route: ActivatedRoute, titleService: Title) {
    ...
    this.personId.valueChanges.subscribe((value: any) => {
