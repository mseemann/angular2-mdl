...
export class ThemeDemo extends AbstractDemoComponent {
  ...
  get stylescheetUrl() {
    ...
    let styleUrl = `https://code.getmdl.io/1.2.0/material.${this.primaryColorName}-${this.accentColorName}.min.css`;
    return styleUrl;
  }
  ...
  private updateStylesheet() {
    ...
    let styleElement: any = document.getElementById('main-css');
