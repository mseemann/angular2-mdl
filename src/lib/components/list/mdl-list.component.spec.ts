...
describe('Components: MdlList*', () => {
  ...
  it('should add the css class mdl-list to the element', () => {
    ...
    let mdlListItemPrimaryContentElement = fixture.debugElement.query(
    ...
    let mdlListItemSecondaryContentElement = fixture.debugElement.query(
    ...
    expect(mdlListIconAvatarElement.nativeElement.classList.contains('mdl-list__item-avatar')).toBe(
      true,
    );

    let mdlListItemSecondaryActionElement = fixture.debugElement.query(
    ...
    expect(
      mdlListItemSubTitleElement.nativeElement.classList.contains('mdl-list__item-sub-title'),
    ).toBe(true);

    let mdlListItemSecondaryInfoElement = fixture.debugElement.query(
    ...
    expect(
      mdlListItemtextBodyElement.nativeElement.classList.contains('mdl-list__item-text-body'),
    ).toBe(true);
  });
