...
import { MdlLayoutModule, MdlLayoutHeaderComponent, MdlLayoutComponent } from './index';
...
describe('Component: MdlLayoutHeader', () => {
  ...
  it('should add the css class mdl-layout__header to the host element', () => {
    ...
    let layoutEl: HTMLElement = fixture.debugElement.query(By.directive(MdlLayoutHeaderComponent))
      .nativeElement;
