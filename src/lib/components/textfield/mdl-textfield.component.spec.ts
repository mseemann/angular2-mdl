...
describe('Component: MdlTextField', () => {
  ...
  it('should support ngModel', async(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      let component = fixture.debugElement.query(By.directive(MdlTextFieldComponent))
        .componentInstance;
  ...
  it('should mark the component as focused and blured', () => {
    ...
    let hostEl: HTMLElement = fixture.debugElement.query(By.directive(MdlTextFieldComponent))
      .nativeElement;
  ...
  describe('globally deactivated native check', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [MdlTextFieldModule, MdlButtonModule, FormsModule],
        declarations: [MdlTestComponent],
        providers: [{ provide: DISABLE_NATIVE_VALIDITY_CHECKING, useValue: true }],
      });
    });
  ...
  it('should be possible to set the focus programmatically', () => {
    TestBed.overrideComponent(MdlTestComponent, {
      set: {
        template: `<mdl-textfield type="text"></mdl-textfield>'`,
      },
    });
    let fixture = TestBed.createComponent(MdlTestComponent);
    ...
    // if called here the inputEl is not set - if the setFocus didn't check for inputEl the next line throws.
    textFieldComonent.setFocus();
    fixture.detectChanges();

    // now it is safe to call setFocus and the focus is set.
    textFieldComonent.setFocus();
    fixture.detectChanges();
  ...
  it('should be possible to disable the textinputfield', async(() => {
    ...
    fixture.whenStable().then(() => {
      let inputElement: HTMLInputElement = fixture.debugElement.query(By.css('input'))
        .nativeElement;
