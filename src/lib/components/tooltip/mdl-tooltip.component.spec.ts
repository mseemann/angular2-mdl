...
describe('Component: MdlTooltip', () => {
  ...
  it('should add the css class mdl-tooltip to the host element', () => {
    ...
    let tooltipEl: HTMLElement = fixture.debugElement.query(By.directive(MdlTooltipComponent))
      .nativeElement;
  ...
  it('should add create a simpletooltipcomponent for the mdl-tooltip directive with text', async(() => {
    ...
    setTimeout(() => {
      ...
      fixture.detectChanges();
      // check the result
      let tooltipEl: HTMLElement = fixture.debugElement.query(
  ...
  it('should add the css class is-active if the mouse enters the directive element', () => {
    ...
    let tooltipTriggerElement = fixture.debugElement.query(By.directive(MdlTooltipDirective))
      .nativeElement;
  ...
  it('should change the tooltip text if the text is changed', () => {
    ...
    let tooltipEl: HTMLElement = fixture.debugElement.query(By.directive(MdlSimpleTooltipComponent))
      .nativeElement;
