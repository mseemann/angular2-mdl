...
import { MdlTabPanelComponent, MdlTabsComponent, MdlTabsModule } from './index';
...
describe('Component: MdlTabsPanel', () => {
  ...
  it('should add the css class isActive to the host element if the panel is active', () => {
    ...
    let tabPanelComponent = fixture.debugElement.query(By.directive(MdlTabPanelComponent))
      .componentInstance;
  ...
  it('should activate the selected tab if the selectedIndex changed programmatically', () => {
    ...
    let mdlLayoutComponent: MdlTabsComponent = fixture.debugElement.query(
