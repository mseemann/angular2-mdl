...
describe('Component: MdlChip', () => {
  ...
  it('should add the css class mdl-chip__contact to the host element and mdl-chip--contact to the mdl-chip', () => {
    ...
    let el: HTMLElement = fixture.debugElement.query(By.directive(MdlChipContactDirective))
      .nativeElement;
    expect(el.classList.contains('mdl-chip__contact')).toBe(true);

    let elChip: HTMLElement = fixture.debugElement.query(By.directive(MdlChipComponent))
      .nativeElement;
