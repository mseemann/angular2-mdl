...
module.exports = {
    ...
    rules: [
      ...
      },
      {
        ...
        use: ExtractTextPlugin.extract({
          use: ['css-loader', postCssLaoder, 'sass-loader'],
      ...
      },
      {
        ...
        loaders: ['raw-loader', postCssLaoder, 'sass-loader'],
      },
      {
        test: /\.hbs$/,
  ...
  plugins: [
    // avoid: WARNING in ./~/@angular/core/@angular/core.fes5.js
    ...
    new CopyWebpackPlugin([{ from: util.root('src', 'demo-app', 'assets'), to: 'assets' }], {
      copyUnmodified: true,
    }),
